...
the [extra exercises](python_lab_exercise_1_extra.qmd#mean-and-standard-deviation).
...
This loads the data as a `pd.DataFrame` which will be [touched on later](python_data_types_extra.qmd) and used extensively in other courses.
